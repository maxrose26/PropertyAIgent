...
- Live coverage: Bury and Stockport fully onboarded with their own Local Plans; all 7 remaining Greater Manchester authorities linked to Places for Everyone with their own allocations onboarded.
...
- Independent Local Plan monitoring for the 7 Greater Manchester authorities currently known to the platform only through Places for Everyone.
