...
def _print_report(report) -> None:
    ...
    print(f"  certificate_a_identity_confirmed_from_form: {report.certificate_a_identity_confirmed_from_form}")
    print(f"  certificate_a_identity_confirmed_via_raw_fallback: {report.certificate_a_identity_confirmed_via_raw_fallback}")
    print(f"  certificate_a_identity_unresolved: {report.certificate_a_identity_unresolved}")
    print(f"  certificate_a_relationships_eligible: {report.certificate_a_relationships_eligible}")
    print(f"  certificate_bcd_identity_unresolved: {report.certificate_bcd_identity_unresolved}")
    print(f"  certificate_bcd_relationships_eligible: {report.certificate_bcd_relationships_eligible}")
    print(f"  certificate_bcd_reported_no_entity: {report.certificate_bcd_reported_no_entity}")
